...
namespace BookQuotes.Controllers
{
    public class QuotesController : Controller
    {
        ...
        {
            return _context.Quote != null ?
                         View("Index", await _context.Quote.Where( j => j.BookName.Contains(SearchBook)).ToListAsync()) :
                         Problem("Entity set 'ApplicationDbContext.Quote'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BookQuote,BookName")] Quote quote)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BookQuote,BookName")] Quote quote)
        {
            if (id != quote.Id)
            {
                return NotFound();
